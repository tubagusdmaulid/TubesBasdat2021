        ...
        <div class="row justify-content-center my-5 text-center">
            ...
            <div class="col-4 offset-1">
                <div class="card text-start" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title text-center">Presensi Karyawan</h5>
                        <p class="card-text">Karyawan dapat melakukan presensi datang dan pulang kerja dengan mengisi form presensi berikut.</p>
                        <a href="presensi.php" class="btn btn-warning">Lanjut Presensi</a>
                    </div>
                </div> 
            </div>
            ...
            <div class="col-4">
                <div class="card text-start" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title text-center">Slip Gaji</h5>
                        <p class="card-text">Karyawan dapat melihat slip gaji dan total gaji dengan menginputkan jumlah  waktu lembur kerja.</p>
                        <a href="slipGaji.php" class="btn btn-warning">Lihat slip gaji</a>
                    </div>
                </div> 
            </div>
