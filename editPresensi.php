...
<body>
    ...
    <h4 class="text-center my-4">Edit Presensi</h4>

    <div class="container">
        <form action="editPresensiUpdate.php" method="post" class="row justify-content-center">
            ...
            <div class="col-3 my-2">
                ...
                <label class="form-label">EDIT Datang</label>
                <input type="time" class="form-control mb-3" name="datang">

                <label class="form-label">EDIT Pulang</label>
                <input type="time" class="form-control mb-3" name="pulang">

                <label class="form-label">EDIT Tanggal</label>
                <input type="date" class="form-control mb-3" name="tanggal">

                <label class="form-label">EDIT Jumlah Jam Lembur </label>
                <input type="int" class="form-control mb-3" name="jumlah_lembur">

                <input type="hidden" name="id">
                <br><button type="submit" class="btn btn-primary" name="tambahPresensi" value="Tambah Presensi">Tambah Presensi</button>
            </div>
